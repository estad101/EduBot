  ...
  useEffect(() => {
    ...
    if (countdown === 0) {
      ...
      try {
        ...
        console.log('Could not close window (may be blocked by browser). Showing fallback message.');
      }
      return;
    }
      ...
      xhr.addEventListener('load', () => {
        ...
        if (xhr.status === 200) {
          try {
            ...
            console.log('✓ Upload successful. Success state set. Countdown will start automatically.');
          } catch (parseError) {
      ...
      <div className="min-h-screen bg-gradient-to-b from-green-600 to-green-800 flex items-center justify-center p-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-gray-500 mb-4 countdown-pulse">
            This page will close in <strong>{countdown !== null ? countdown : 3}</strong> second{countdown !== 1 ? 's' : ''}...
          </p>
